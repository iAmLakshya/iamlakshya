...
import { CommitWait } from "@/components/notes/diagrams";

export const metadata = {
  "title": "Database Comparisons — System Design Notes",
  "description": "Relational against document, MySQL against PostgreSQL, VoltDB, Spanner, and MongoDB against Cassandra"
};

# Database Comparisons

## <Mark>Relational against non-relational</Mark>
...
## <Mark>MySQL against PostgreSQL</Mark>
...
## <Mark>MongoDB against Apache Cassandra</Mark>
...
- [Transactions and Isolation](/notes/system-design/transactions) - the isolation levels these systems implement.
- [Replication](/notes/system-design/replication) - Cassandra is the leaderless reference implementation.
