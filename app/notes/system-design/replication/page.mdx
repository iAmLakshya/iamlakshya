...
import { MerkleTreeDiff, QuorumExplorer, ReplicationTopology, SingleLeader, VersionVectors } from "@/components/notes/diagrams";

export const metadata = {
  "title": "Replication — System Design Notes",
...
## <Mark>Intro to replication</Mark>
...
### <Mark>Asynchronous replication</Mark>
...
runs. The same modulus problem turns up in [Partitioning](/notes/system-design/partitioning), where it is the argument for consistent
hashing.
...
## <Mark>Single leader replication</Mark>
...
[Consensus and Linearizability](/notes/system-design/consensus). No node can tell a dead leader from a slow one, and the
...
## <Mark>Multi-leader replication</Mark>
...
## <Mark>Dealing with write conflicts</Mark>
...
## <Mark>Leaderless replication</Mark>
...
- [Partitioning](/notes/system-design/partitioning), usually configured alongside replication.
- [Consensus and Linearizability](/notes/system-design/consensus), what it takes to make replication linearizable.
- [Database Comparisons](/notes/system-design/database-comparisons), where Cassandra and Riak are the leaderless reference implementations.
