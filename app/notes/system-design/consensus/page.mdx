...
import { LinearizabilityTimeline, RaftLogMatch } from "@/components/notes/diagrams";

export const metadata = {
  "title": "Consensus and Linearizability — System Design Notes",
...
## <Mark>Linearizable database</Mark>
...
## <Mark>Distributed consensus: Raft leader election</Mark>
...
## <Mark>Distributed consensus: Raft writes</Mark>
...
## <Mark>Zookeeper: coordination services</Mark>
...
- [Replication](/notes/system-design/replication) - what consensus is called in to fix.
- [Database Comparisons](/notes/system-design/database-comparisons) - Spanner's approach to ordering without a single consensus bottleneck.
