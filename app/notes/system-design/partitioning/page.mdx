...
import { ConsistentHashRing, SecondaryIndex } from "@/components/notes/diagrams";

export const metadata = {
  "title": "Partitioning — System Design Notes",
...
## <Mark>Partitioning schemes</Mark>
...
## <Mark>Two-phase commit: distributed transactions</Mark>
...
- [Replication](/notes/system-design/replication) - partitioning is configured alongside replication.
- [Database Comparisons](/notes/system-design/database-comparisons) - Cassandra partitions by cluster key, HBase by range.
