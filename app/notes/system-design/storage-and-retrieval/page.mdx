...
import { BTreeFanout, LsmFlush, RowVsColumn, WriteAmplification } from "@/components/notes/diagrams";

export const metadata = {
  "title": "Storage and Retrieval — System Design Notes",
...
## <Mark>LSM-tree and SSTables</Mark>
...
## <Mark>Column-oriented storage (Parquet)</Mark>
...
## <Mark>Data serialisation frameworks</Mark>
...
- [Transactions and Isolation](/notes/system-design/transactions) - what the storage engine has to guarantee under concurrency.
- [Database Comparisons](/notes/system-design/database-comparisons) - which engines pick which of these structures.
