...
import { BrokerFanout, CdcVsBatch, FlinkBarriers, Flow, HeadOfLine, LogBroker, TimeWindows } from "@/components/notes/diagrams";

export const metadata = {
  "title": "Stream Processing — System Design Notes",
...
<Flow steps={[{label:"Client",sub:"write"},{label:"Database",sub:"source of truth",tint:"ink"},{label:"Broker"},{label:"Search index",sub:"derived data",tint:"accent"}]} />
...
<Flow steps={[{label:"Client",sub:"raw event"},{label:"Broker",sub:"retains events",tint:"ink"},{label:"Consumer"},{label:"Database",tint:"accent"}]} note="Because the broker keeps the raw events, a new consumer can be added later and replay history into a brand new derived store." />
...
## <Mark>Kafka against RabbitMQ</Mark>
...
## <Mark>Stream joins and enrichment</Mark>
...
- [Batch Processing](/notes/system-design/batch-processing) - Spark, and the batch counterpart to these joins.
- [Search and Specialised Stores](/notes/system-design/search-and-specialised-stores) - the search index CDC usually feeds.
